...
public class MergeSort_2SubArray {
    ...
    static void mergeSort(int[] a, int left, int right)
    {
        ...
        if(left < right)
        {
            ...
            // this can avoid date type overflow
            mid = (left + right) / 2;

            // recursive calls to sort first half and second half sub-array
    ...
    static void merge(int[] arr, int left, int mid, int right)
    {
        ...
        // Copy the remaning elements of L[], if any
        while(i < n1) {
            arr[k] = L[i];
            i++;
            k++;
